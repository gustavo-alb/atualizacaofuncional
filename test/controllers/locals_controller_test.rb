...
class LocalsControllerTest < ActionController::TestCase
  ...
  test "should create local" do
    assert_difference('Local.count') do
      post :create, local: { codigo: @local.codigo, local_pai_id: @local.local_pai_id, municipio_id: @local.municipio_id, nome: @local.nome, tipo: @local.tipo }
    end
  ...
  test "should update local" do
    patch :update, id: @local, local: { codigo: @local.codigo, local_pai_id: @local.local_pai_id, municipio_id: @local.municipio_id, nome: @local.nome, tipo: @local.tipo }
    assert_redirected_to local_path(assigns(:local))
  end
